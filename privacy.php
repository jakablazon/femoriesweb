...
1. Use the App or Services for any illegal purpose, or in violation of any local, state, national, or international law, including, without limitation, laws governing intellectual property and other proprietary rights, and data protection and privacy.
2. Remove, circumvent, disable, damage or otherwise interfere with security-related features of the App or Services, features that prevent or restrict use or copying of any content accessible through the App, or features that enforce limitations on the use of the App.
3. Reverse engineer, decompile, disassemble or otherwise attempt to discover the source code of the App or any part thereof.
4. Modify, adapt, translate or create derivative works based upon the App or any part thereof;
5. Intentionally interfere or attempt to interfere with or damage proper operation of the App or Services or any User’s enjoyment of them, by any means, including uploading or otherwise disseminating viruses, adware, spyware, worms, or other malicious code.
6. Impose or attempt to impose on the App an unreasonably large load on App's infrastructure or make automated use of the Services.
7. Reproduce, duplicate, copy, sell, resell, visit, or otherwise exploit the App or Services for any commercial purpose.
...
We may make changes to the materials, products, features and services available on the App at any time without notice.
               ...
               <h3> Extra paragraph </h3>

             <p> This is Apple watch app only. All the content is generated by Facebook users and Femories is not owner of the content, it only collects it in an album for the users. </p>
